...
@HippoEssentialsGenerated(internalName = "seocms:contentdocument")
@Node(jcrType = "seocms:contentdocument")
public class ContentDocument extends BaseDocument {
    @HippoEssentialsGenerated(internalName = "seocms:introduction")
    public String getIntroduction() {
        return getProperty("seocms:introduction");
    }
    ...
    public Calendar getPublicationDate() {
        return getProperty("seocms:publicationdate");
    }
}
