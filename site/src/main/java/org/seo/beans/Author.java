...
@Node(jcrType = "seocms:author")
public class Author extends HippoDocument implements AuthorEntry {

    public static final String ROLE = "seocms:role";
    public static final String ACCOUNTS = "seocms:accounts";
    public static final String FULL_NAME = "seocms:fullname";
    public static final String IMAGE = "seocms:image";
    public static final String CONTENT = "seocms:content";

    @HippoEssentialsGenerated(internalName = "seocms:fullname")
    ...
    @HippoEssentialsGenerated(internalName = "seocms:role")
    ...
    public HippoGalleryImage getImage() {
  	...
  	@HippoEssentialsGenerated(internalName = "seocms:accounts")
