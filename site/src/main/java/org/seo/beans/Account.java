...
@HippoEssentialsGenerated(internalName = "seocms:account")
@Node(jcrType = "seocms:account")
public class Account extends HippoCompound {

    public static final String TYPE = "seocms:type";
    public static final String LINK = "seocms:link";

    @HippoEssentialsGenerated(internalName = "seocms:type")
